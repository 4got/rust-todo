...
pub mod tests {
    ...
    //     TodoList::add_to_db(Todo::new(String::from("Add completion by index"), false, 1)).unwrap();
    ...
    #[test]
    fn print_lists() {
        let todo_list = TodoList::from_db_as_lists();
        for todo_list in todo_list {
            todo_list.print();
        }
    }
    ...
    #[test]
    fn add_new_todo() {
        TodoList::delete_in_db(12).unwrap();
    }
}
